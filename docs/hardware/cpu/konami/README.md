...
| lsld #imm | 0xBE | lsl D register, (#imm & 0xF) times | crimfght = Bad result (random junk in registers)<br>vendetta = Works |
| lsld $mem | 0xBF | lsl word stored at $mem, (A register & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
| lslw $mem | 0xA6 | lsl word stored at $mem one time| crimfght = Works<br>vendetta = Works |
| lsrd #imm | 0xB8 | lsr D register, (#imm & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
| lsrd $mem | 0xB9 | lsr word stored at $mem, (A register & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
...
| rold #imm | 0xC0 | rol D register, (#imm & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
| rold $mem | 0xC1 | rol word stored at $mem, (A register & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
| rolw $mem | 0xA7 | rol word stored at $mem one time | crimfght = Works<br>vendetta = Works |
| rord #imm | 0xBA | ror D register, (#imm & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
| rord $mem | 0xBB | ror word stored at $mem, (A register & 0xF) times | crimfght = CPU Crash<br>vendetta = Works |
...
| setline $mem | 0x39 | Sets some banking related values in the CPU | crimfght = Works<br>vendetta = Works |

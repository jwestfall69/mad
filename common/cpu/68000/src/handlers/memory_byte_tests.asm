...
memory_byte_tests_handler_dsub:
		movea.l	a0, a6
	...
	.memory_list:
		...
		move.l	s_mt_address_list(a6), a0
		move.b	s_mt_lower_byte_only(a6), d0
		DSUB	memory_byte_write_list_test
		tst.b	d0
		bne	.test_failed_write

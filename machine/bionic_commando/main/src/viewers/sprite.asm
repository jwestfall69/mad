...
sprite_viewer_palette_setup:
		...
		move.l	#SPRITE_PALETTE, r_vblank_copy_dst
		move.w	#(SPRITE_PALETTE_SIZE / 2), r_vblank_copy_size
...
d_palette_data:
	dc.w	$000f, $da6f, $b80f, $850f, $89df, $67bf, $058f, $777f
	dc.w	$aaaf, $cccf, $c50f, $940f, $5cbf, $0a7f, $085f, $111f

...
d_ec_list:
	...
	EC_ENTRY EC_FG_TILE_RAM_WRITE, PRINT_ERROR_HEX_BYTE, d_str_fg_tile_ram_write
	...
	EC_ENTRY EC_PALETTE_RAM_WRITE, PRINT_ERROR_MEMORY, d_str_palette_ram_write
	...
	EC_ENTRY EC_SPRITE_RAM_WRITE, PRINT_ERROR_HEX_BYTE, d_str_sprite_ram_write
...
d_str_fg_tile_ram_output:		STRING "FG TILE RAM DEAD OUTPUT"

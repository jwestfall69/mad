...
; error addresses  0x6000 = 001x xxxx xrrr rrrr
;  x = error code
;  r = refresh/useable
;
; This puts 3 of the error code bits in conflict with having to write to
; the watchdog.  error address jump locations exist every 128 bytes, 0x6000,
; 0x6080, 0x6100, etc.  Normally we would just have a jump self at each of

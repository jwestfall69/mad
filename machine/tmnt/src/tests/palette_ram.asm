...
manual_palette_ram_tests:
	...
	align 2
MT_DATA:
	MT_PARAMS PALETTE_RAM_START, MT_NULL_ADDRESS_LIST, PALETTE_RAM_SIZE, PALETTE_RAM_ADDRESS_LINES, PALETTE_RAM_MASK, MT_TEST_LOWER_ONLY, PALETTE_RAM_BASE_EC

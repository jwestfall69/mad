...
d_mt_data1:
	MT_PARAMS TILE_RAM_START, MT_NULL_ADDRESS_LIST, $1000, 12, TILE_RAM_MASK, TILE_RAM_BASE_EC, MT_FLAG_NONE

d_mt_data2:
	MT_PARAMS TILE_RAM_START+$2000, MT_NULL_ADDRESS_LIST, $1000, 12, TILE_RAM_MASK, TILE_RAM_BASE_EC, MT_FLAG_NONE

d_mt_data3:
	MT_PARAMS TILE_RAM_START+$4000, MT_NULL_ADDRESS_LIST, $1000, 12, TILE_RAM_MASK, TILE_RAM_BASE_EC, MT_FLAG_NONE

d_mt_data4:
	MT_PARAMS TILE_RAM_START+$6000, MT_NULL_ADDRESS_LIST, $800, 12, TILE_RAM_MASK, TILE_RAM_BASE_EC, MT_FLAG_NONE

...
d_ec_list:
	...
	EC_ENTRY EC_SPRITE1_RAM_ADDRESS, PRINT_ERROR_MEMORY, d_str_sprite1_ram_address
	EC_ENTRY EC_SPRITE1_RAM_DATA, PRINT_ERROR_MEMORY, d_str_sprite1_ram_data
	EC_ENTRY EC_SPRITE1_RAM_MARCH, PRINT_ERROR_MEMORY, d_str_sprite1_ram_march
	EC_ENTRY EC_SPRITE1_RAM_OUTPUT, PRINT_ERROR_ADDRESS, d_str_sprite1_ram_output
	EC_ENTRY EC_SPRITE1_RAM_WRITE, PRINT_ERROR_ADDRESS, d_str_sprite1_ram_write

	EC_ENTRY EC_SPRITE2_RAM_ADDRESS, PRINT_ERROR_MEMORY, d_str_sprite2_ram_address
	EC_ENTRY EC_SPRITE2_RAM_DATA, PRINT_ERROR_MEMORY, d_str_sprite2_ram_data
	EC_ENTRY EC_SPRITE2_RAM_MARCH, PRINT_ERROR_MEMORY, d_str_sprite2_ram_march
	EC_ENTRY EC_SPRITE2_RAM_OUTPUT, PRINT_ERROR_ADDRESS, d_str_sprite2_ram_output
	EC_ENTRY EC_SPRITE2_RAM_WRITE, PRINT_ERROR_ADDRESS, d_str_sprite2_ram_write
	...
	EC_ENTRY EC_TILE3_RAM_DATA, PRINT_ERROR_MEMORY, d_str_tile3_ram_data
	EC_ENTRY EC_TILE3_RAM_MARCH, PRINT_ERROR_MEMORY, d_str_tile3_ram_march
	EC_ENTRY EC_TILE3_RAM_OUTPUT, PRINT_ERROR_ADDRESS, d_str_tile3_ram_output
	EC_ENTRY EC_TILE3_RAM_WRITE, PRINT_ERROR_ADDRESS, d_str_tile3_ram_write
	EC_LIST_END
...
d_str_sprite1_ram_address:	STRING "SPRITE1 RAM ADDRESS"
d_str_sprite1_ram_data:		STRING "SPRITE1 RAM DATA"
d_str_sprite1_ram_march:	STRING "SPRITE1 RAM MARCH"
d_str_sprite1_ram_output:	STRING "SPRITE1 RAM DEAD OUTPUT"
d_str_sprite1_ram_write:	STRING "SPRITE1 RAM WRITE"

d_str_sprite2_ram_address:	STRING "SPRITE2 RAM ADDRESS"
d_str_sprite2_ram_data:		STRING "SPRITE2 RAM DATA"
d_str_sprite2_ram_march:	STRING "SPRITE2 RAM MARCH"
d_str_sprite2_ram_output:	STRING "SPRITE2 RAM DEAD OUTPUT"
d_str_sprite2_ram_write:	STRING "SPRITE2 RAM WRITE"
...
d_str_tile3_ram_data:		STRING "TILE3 RAM DATA"
d_str_tile3_ram_march:		STRING "TILE3 RAM MARCH"
d_str_tile3_ram_output:		STRING "TILE3 RAM DEAD OUTPUT"
d_str_tile3_ram_write:		STRING "TILE3 RAM WRITE"

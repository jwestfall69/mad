...
d_memory_fill_list:
		...
		MEMORY_FILL_ENTRY TILE1_RAM, TILE1_RAM_SIZE, $0
		MEMORY_FILL_ENTRY TILE2_RAM, TILE2_RAM_SIZE, $0
		MEMORY_FILL_ENTRY TILE3_RAM, TILE3_RAM_SIZE, $0
		MEMORY_FILL_ENTRY SPRITE_RAM, SPRITE_RAM_SIZE, $0
		MEMORY_FILL_ENTRY PALETTE_RAM, PALETTE_RAM_SIZE, $0
		MEMORY_FILL_ENTRY PALETTE_EXT_RAM, PALETTE_EXT_RAM_SIZE, $0

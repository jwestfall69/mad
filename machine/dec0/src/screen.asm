...
MEMORY_FILL_LIST:
		...
		MEMORY_FILL_ENTRY TILE1_DATA_START, TILE1_DATA_SIZE, $0
		MEMORY_FILL_ENTRY TILE2_DATA_START, TILE2_DATA_SIZE, $0
		MEMORY_FILL_ENTRY TILE3_DATA_START, TILE3_DATA_SIZE, $0

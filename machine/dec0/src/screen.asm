...
MEMORY_FILL_LIST:
		MEMORY_FILL_ITEM REG_TILE1_CTRL2, $4, $0
		MEMORY_FILL_ITEM REG_TILE2_CTRL1, $4, $0
		MEMORY_FILL_ITEM REG_TILE2_CTRL2, $4, $0
		MEMORY_FILL_ITEM REG_TILE3_CTRL1, $4, $0
		MEMORY_FILL_ITEM REG_TILE3_CTRL2, $4, $0
		MEMORY_FILL_ITEM TILE1_DATA_START, (TILE1_DATA_SIZE / 2), $0
		MEMORY_FILL_ITEM TILE2_DATA_START, (TILE2_DATA_SIZE / 2), $0
		MEMORY_FILL_ITEM TILE3_DATA_START, (TILE3_DATA_SIZE / 2), $0
		MEMORY_FILL_ITEM SPRITE_RAM_START, (SPRITE_RAM_SIZE / 2), $0

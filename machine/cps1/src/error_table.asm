...
EC_TABLE:
	...
	EC_ENTRY GFX_RAM_OUTPUT_LOWER, PRINT_ERROR_STRING
	EC_ENTRY GFX_RAM_OUTPUT_UPPER, PRINT_ERROR_STRING
	EC_ENTRY GFX_RAM_OUTPUT_BOTH, PRINT_ERROR_STRING
	EC_ENTRY GFX_RAM_WRITE_LOWER, PRINT_ERROR_STRING
	EC_ENTRY GFX_RAM_WRITE_UPPER, PRINT_ERROR_STRING
	EC_ENTRY GFX_RAM_WRITE_BOTH, PRINT_ERROR_STRING

...
EC_LIST:
	...
	EC_ENTRY GFX_RAM_MARCH_LOWER, PRINT_ERROR_MEMORY
	EC_ENTRY GFX_RAM_MARCH_UPPER, PRINT_ERROR_MEMORY
	EC_ENTRY GFX_RAM_MARCH_BOTH, PRINT_ERROR_MEMORY
...
STR_GFX_RAM_MARCH_LOWER:	STRING "GFX RAM MARCH (LOWER)"
STR_GFX_RAM_MARCH_UPPER:	STRING "GFX RAM MARCH (UPPER)"
STR_GFX_RAM_MARCH_BOTH:		STRING "GFX RAM MARCH (BOTH)"

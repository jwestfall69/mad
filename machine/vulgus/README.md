...
## MAD Pictures
![mad vulgus main menu](docs/images/mad_vulgus_main_menu.png)
![mad vulgus fix tile viewer](docs/images/mad_vulgus_fix_tile_viewer.png)
![mad vulgus sprite viewer](docs/images/mad_vulgus_sprite_viewer.png)

## PCB Pictures
**IMPORTANT**: Vulgus is **NOT** JAMMA.  Using a JAMMA harness will damage
...
<a href="docs/images/vulgus_cpu_pcb_top.png"><img src="docs/images/vulgus_cpu_pcb_top.png" width="40%"></a>
<a href="docs/images/vulgus_cpu_pcb_bottom.png"><img src="docs/images/vulgus_cpu_pcb_bottom.png" width="40%"></a>
<p>
<a href="docs/images/vulgus_graphics_pcb_top.png"><img src="docs/images/vulgus_graphics_pcb_top.png" width="40%"></a>
<a href="docs/images/vulgus_graphics_pcb_bottom.png"><img src="docs/images/vulgus_graphics_pcb_bottom.png" width="40%"></a>
<p>

## Manual / Schematics
[Manual](docs/vulgus_manual.pdf)<br>

I wasn't able to find any schematics, but vulgus PCB is vary similar to 1942 which
there are [schematics](../1942/docs/1942_schematics.pdf) for.  Just be mindful
some of the IC locations might not be the same.

## MAD Eproms

| Diag | Eprom Type | Location | Notes |
| ---- | ---------- | ----------- | ----- |
| Main | 27c64 | vulgus.002 @ N4 on CPU Board<br>vulgus.003 @ N5 on CPU Board<br>vulgus.004 @ N6 on CPU Board<br>vulgus.005 @ N7 on CPU Board<br> | |
| Sound | 27c64 | C11 | No MAD ROM exists yet |

Unfortunately it takes 4x 27c64 roms to use mad on this board.

## RAM Locations
| RAM | Location | Type |
| -------- | :------- | ----- |
| BG Tile RAM | A10 on Graphics Board | TMM2016AP-15 (2k x 8bit) |
| Fix Tile RAM | H2 on CPU Board | TMM2116AP-10 (2k x 8bit) |
| Sound RAM | C10 on CPU Board | TMM2116AP-10 (2k x 8bit) |
| Work RAM | N9 on CPU Board | TMM2116AP-10 (2k x 8bit) |
| Work High RAM | N10 on CPU Board | TMM2116AP-10 (2k x 8bit) |
...
<sup>Table last updated by gen-error-codes-markdown-table on 2026-06-12 @ 04:23 UTC</sup>
<!-- ec_table_main_end -->

...
d_ec_list:
	...
	EC_ENTRY EC_WORK_HIGH_RAM_ADDRESS, PRINT_ERROR_MEMORY, d_str_work_high_ram_address
	EC_ENTRY EC_WORK_HIGH_RAM_DATA, PRINT_ERROR_MEMORY, d_str_work_high_ram_data
	EC_ENTRY EC_WORK_HIGH_RAM_MARCH, PRINT_ERROR_MEMORY, d_str_work_high_ram_march
	EC_ENTRY EC_WORK_HIGH_RAM_OUTPUT, PRINT_ERROR_ADDRESS, d_str_work_high_ram_output
	EC_ENTRY EC_WORK_HIGH_RAM_WRITE, PRINT_ERROR_HEX_BYTE, d_str_work_high_ram_write
	EC_LIST_END
...
d_str_work_high_ram_address:		STRING "WORK HIGH RAM ADDRESS"
d_str_work_high_ram_data:		STRING "WORK HIGH RAM DATA"
d_str_work_high_ram_march:		STRING "WORK HIGH RAM MARCH"
d_str_work_high_ram_output:		STRING "WORK HIGH RAM DEAD OUTPUT"
d_str_work_high_ram_write:		STRING "WORK HIGH RAM WRITE"

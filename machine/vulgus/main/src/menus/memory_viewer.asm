...
d_menu_list:
	...
	MENU_ENTRY view_bg_tile_attr_ram, d_str_bg_tile_attr_ram, ME_FLAG_NONE
	...
	MENU_ENTRY view_work_high_ram, d_str_work_high_ram, ME_FLAG_NONE
	MENU_LIST_END

d_str_menu_title:	STRING "MEMORY VIEWER MENU"

d_str_bg_tile_ram:		STRING "BG TILE RAM"
d_str_bg_tile_attr_ram:		STRING "BG TILE ATTR RAM"
...
d_str_work_high_ram:		STRING "WORK HIGH RAM"

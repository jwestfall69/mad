	...
	global k007121_sprite_viewer
	global k007121_sprite_viewer_palette_setup

	section code

k007121_sprite_viewer:
...
value_changed_cb:
	...
	.skip_sprite_flip_x:
		...
		ora	r_scratch
		ora	r_sprite_pos_x
		sta	K007121_SPRITE + 4

		lda	r_sprite_pos_x + 1
		sta	K007121_SPRITE + 3
		lda	r_sprite_pos_y
		sta	K007121_SPRITE + 2
		rts
...
; Palette Layout
;  xBBB BBGG GGGR RRRR
k007121_sprite_viewer_palette_setup:
		ldx	#d_palette_data
		ldy	#K007121_SPRITE_PALETTE
		ldb	#PALETTE_SIZE
...
d_palette_data:
	dc.w	$0000, $4a31, $ab30, $ed45, $0e4e, $905a, $156b, $9877
	dc.w	$007c, $6a7e, $4104, $da7f, $0629, $ff3f, $de36, $fb21

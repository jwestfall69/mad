...
sprite_viewer:
		...
		move.w	#$b7, r_sprite_num
		move.w	#$100, r_sprite_pos_x
...
; * word |        Bit(s)      | Use
; * -----+-fedcba098 76543210-+----------------
; *   0  | xxxxxxxxx xxxxxxxx | sprite num
; *   1  | --------- -x------ | flip y
; *   1  | --------- --x----- | flip x
; *   1  | --------- ----xxxx | palette num
; *   2  | --------x xxxxxxxx | y position
; *   3  | --------x xxxxxxxx | x position
value_changed_cb:
		move.w	r_sprite_num, SPRITE_RAM + $800
		move.w	r_sprite_pos_x, SPRITE_RAM + $806
		move.w	r_sprite_pos_y, SPRITE_RAM + $804
...
d_palette_data:
	dc.w	$111f, $eeef, $aaaf, $f96f, $c53f, $810f, $600f, $059f
	dc.w	$09ff, $777f, $3c6f, $285f, $e70f, $333f, $ec0f, $000f

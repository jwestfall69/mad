...
MENU_LIST:
	...
	MAIN_MENU_ENTRY manual_bg_ram_tests, STR_BG_RAM_TEST
	MAIN_MENU_ENTRY manual_fg_ram_tests, STR_FG_RAM_TEST
	MAIN_MENU_ENTRY manual_palette_ram_tests, STR_PALETTE_RAM_TEST
	MAIN_MENU_ENTRY manual_sprite_ram_tests, STR_SPRITE_RAM_TEST

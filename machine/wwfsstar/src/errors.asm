...
EC_LIST:
	...
	EC_ENTRY BG_RAM_DATA, PRINT_ERROR_MEMORY
	EC_ENTRY BG_RAM_MARCH, PRINT_ERROR_MEMORY
	EC_ENTRY BG_RAM_OUTPUT, PRINT_ERROR_ADDRESS
	EC_ENTRY BG_RAM_WRITE, PRINT_ERROR_ADDRESS
...
STR_BG_RAM_MARCH:		STRING "BG RAM MARCH"
STR_BG_RAM_OUTPUT:		STRING "BG RAM DEAD OUTPUT"
STR_BG_RAM_WRITE:		STRING "BG RAM WRITE"

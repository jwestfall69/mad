...
d_auto_test_func_list:
	;AUTO_TEST_ENTRY auto_bg_ram_tests, d_str_testing_fg_ram
	...
	AUTO_TEST_ENTRY auto_txt_ram_tests, d_str_testing_txt_ram
	AUTO_TEST_LIST_END
...
d_str_testing_txt_ram:			STRING "TESTING TXT RAM"

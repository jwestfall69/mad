...
input_test:
		...
		lda	#(CTRL_FIRQ_ENABLE|CTRL_IRQ_ENABLE|CTRL_NMI_ENABLE)
...
d_screen_xys_list:
	...
	XY_STRING (SCREEN_START_X + 1), (SCREEN_START_Y + 5), "SYS"
	XY_STRING (SCREEN_START_X + 0), (SCREEN_START_Y + 6), "DSW1"
	XY_STRING (SCREEN_START_X + 0), (SCREEN_START_Y + 7), "DSW2"
	XY_STRING (SCREEN_START_X + 0), (SCREEN_START_Y + 8), "DSW3"

	XY_STRING (SCREEN_START_X + 14), (SCREEN_START_Y + 3), "FIRQ"
	XY_STRING (SCREEN_START_X + 15), (SCREEN_START_Y + 4), "IRQ"
	XY_STRING (SCREEN_START_X + 15), (SCREEN_START_Y + 5), "NMI"
	XY_STRING_LIST_END

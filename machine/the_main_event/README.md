...
![mad the main event sprite viewer](docs/images/mad_the_main_event_sprite_viewer.png)
...
HD6309 CPU are are 6 bits.  the main event however has a watchdog address that must

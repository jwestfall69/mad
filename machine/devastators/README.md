...
## MAD Pictures
![mad devastators main menu](docs/images/mad_devastators_main_menu.png)
![mad devastators video dac test](docs/images/mad_devastators_video_dac_test.png)<br>
![mad devastators fix tile viewer](docs/images/mad_devastators_fix_tile_viewer.png)
![mad devastators sprite viewer](docs/images/mad_devastators_sprite_viewer.png)

## PCB Pictures
<a href="docs/images/devastators_pcb_top.png"><img src="docs/images/devastators_pcb_top.png" width="40%"></a>
<a href="docs/images/devastators_pcb_bottom.png"><img src="docs/images/devastators_pcb_bottom.png" width="40%"></a>
<p>

## Manual / Schematics
[Manual](docs/devastators_manual.pdf)<br>
[Schematics](docs/devastators_schematics.pdf)

## MAD Eproms

| Diag | Eprom Type | Location | Notes |
| ---- | ---------- | ----------- | ----- |
| Main | 27c512 | 890z02.k11 @ K11 | |
...
HD6309 CPU are are 6 bits.  Devastators however has a watchdog address that must
...
<sup>Table last updated by gen-error-codes-markdown-table on 2025-06-03 @ 01:29 UTC</sup>
<!-- ec_table_main_end -->

...
OBJS = $(OBJ_DIR)/cpu/z80/src/crc32.o \
       ...
       $(OBJ_DIR)/cpu/z80/src/handlers/input_test.o \
       ...
       $(OBJ_DIR)/cpu/z80/src/handlers/tile_16x16_viewer.o \
...
OBJS += $(OBJ_DIR)/$(MAD_NAME).o \
        ...
        $(OBJ_DIR)/tests/bg_tile_ram.o \
        $(OBJ_DIR)/tests/fix_tile_ram.o \
        $(OBJ_DIR)/tests/input.o \
        $(OBJ_DIR)/tests/sound_fm.o \
        $(OBJ_DIR)/tests/sound_adpcm.o \
        $(OBJ_DIR)/viewers/bg_image.o \
        $(OBJ_DIR)/viewers/bg_tile.o \
        $(OBJ_DIR)/viewers/fix_tile.o \
        $(OBJ_DIR)/viewers/sprite.o

ifneq (,$(findstring _DEBUG_HARDWARE_,$(BUILD_FLAGS)))
OBJS += $(OBJ_DIR)/cpu/z80/src/debug/hardware/watchdog_time.o \
        $(OBJ_DIR)/cpu/z80/src/handlers/memory_write.o \
...
src/version.asm:
	../../../util/gen-version-asm-file -m "CAPCOM 85608" -r $(ROMSET) -i ../../../common/global/src/version.asm.in -o src/version.asm

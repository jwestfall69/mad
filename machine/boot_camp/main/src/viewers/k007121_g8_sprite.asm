	...
	global k007121_g8_sprite_viewer
	global k007121_g8_sprite_viewer_palette_setup

	section code

k007121_g8_sprite_viewer:
		jsr	k007121_g8_sprite_viewer_palette_setup
...
value_changed_cb:
		...
		ldd	r_sprite_num
		stb	K007121_G8_SPRITE

		tfr	a, b
		andb	#$f
		stb	K007121_G8_SPRITE + 1
	...
	.skip_sprite_flip_x:
		...
		ora	r_scratch
		ora	r_sprite_pos_x
		sta	K007121_G8_SPRITE + 4

		lda	r_sprite_pos_x + 1
		sta	K007121_G8_SPRITE + 3
		lda	r_sprite_pos_y
		sta	K007121_G8_SPRITE + 2
...
; Palette Layout
;  xBBB BBGG GGGR RRRR
k007121_g8_sprite_viewer_palette_setup:
		ldx	#d_palette_data
		ldy	#K007121_G8_SPRITE_PALETTE
		ldb	#PALETTE_SIZE
...
d_palette_data:
	dc.w	$0000, $bd77, $ab21, $7136, $163f, $3d3e, $5932, $4a29
	dc.w	$ef39, $7346, $0c15, $0b15, $0000, $154c, $1f00, $c410

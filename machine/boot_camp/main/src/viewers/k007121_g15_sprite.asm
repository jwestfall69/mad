	...
	global k007121_g15_sprite_viewer
	global k007121_g15_sprite_viewer_palette_setup

	section code

k007121_g15_sprite_viewer:
...
value_changed_cb:
		ldd	r_sprite_num
		stb	K007121_G15_SPRITE

		tfr	a, b
		andb	#$f
		stb	K007121_G15_SPRITE + 1
	...
	.skip_sprite_flip_x:
		...
		ora	r_scratch
		ora	r_sprite_pos_x
		sta	K007121_G15_SPRITE + 4

		lda	r_sprite_pos_x + 1
		sta	K007121_G15_SPRITE + 3
		lda	r_sprite_pos_y
		sta	K007121_G15_SPRITE + 2
		rts
...
; Palette Layout
;  xBBB BBGG GGGR RRRR
k007121_g15_sprite_viewer_palette_setup:
		ldx	#d_palette_data
		ldy	#K007121_G15_SPRITE_PALETTE
		ldb	#PALETTE_SIZE
...
d_palette_data:
	...
	dc.w	$ef39, $7346, $0c15, $365e, $0000, $15c4, $1f00, $c410

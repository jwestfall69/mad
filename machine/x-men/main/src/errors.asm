...
d_ec_list:
	...
	EC_ENTRY EC_TILE_EXT_RAM_ADDRESS, PRINT_ERROR_MEMORY, d_str_tile_ext_ram_address
	EC_ENTRY EC_TILE_EXT_RAM_DATA, PRINT_ERROR_MEMORY, d_str_tile_ext_ram_data
	EC_ENTRY EC_TILE_EXT_RAM_MARCH, PRINT_ERROR_MEMORY, d_str_tile_ext_ram_march
	EC_ENTRY EC_TILE_EXT_RAM_OUTPUT, PRINT_ERROR_ADDRESS, d_str_tile_ext_ram_output
	EC_ENTRY EC_TILE_EXT_RAM_WRITE, PRINT_ERROR_ADDRESS, d_str_tile_ext_ram_write
...
d_str_tile_ext_ram_address:		STRING "TILE EXT RAM ADDRESS"
d_str_tile_ext_ram_data:		STRING "TILE EXT RAM DATA"
d_str_tile_ext_ram_march:		STRING "TILE EXT RAM MARCH"
d_str_tile_ext_ram_output:		STRING "TILE EXT RAM DEAD OUTPUT"
d_str_tile_ext_ram_write:		STRING "TILE EXT RAM WRITE"

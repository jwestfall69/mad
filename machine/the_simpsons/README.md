...
## MAD Pictures
![mad simpsons main menu](docs/images/mad_simpsons_main_menu.png)
![mad simpsons video dac test](docs/images/mad_simpsons_video_dac_test.png)<br>
![mad simpsons fix tile viewer](docs/images/mad_simpsons_fix_tile_viewer.png)
![mad simpsons sprite viewer](docs/images/mad_simpsons_sprite_viewer.png)

## PCB Pictures
<a href="docs/images/simpsons_pcb_top.png"><img src="docs/images/simpsons_pcb_top.png" width="40%"></a>
<a href="docs/images/simpsons_pcb_bottom.png"><img src="docs/images/simpsons_pcb_bottom.png" width="40%"></a>
<p>

## Manual / Schematics
[Manual w/Schematics](docs/simpsons_manual_schematics.pdf)
...
| ---- | ---------- | ----------- | ----- |
| Main | 27c010 | 072-j12.15c @ 15C | |
| Sound | 27c512 | 6G | No MAD ROM exists yet |

## RAM Locations
| RAM | Location | Type |
| -------- | :------- | ----- |
| Palette RAM (Odd Addresses) | 9G | MCM2018AN45 (2k x 8bit) |
| Palette RAM (Even Addresses) | 8G | MCM2018AN45 (2k x 8bit) |
| Sound RAM | 7G | MB8416A-15L-SK (2k x 8bit) |
| Sprite RAM | 1J | MB8464A-10L-SK (8k x 8bit) |
| Tile RAM | 16G | MB8464A-10L-SK (8k x 8bit) |
| Tile Attr RAM | 16F | MB8464A-10L-SK (8k x 8bit) |
| Work RAM | 11F | MB8464A-10L-SK (8k x 8bit) |
...
Konami2 CPU are are 6 bits.  simpsons however has a watchdog address that must
be written to periodically or the game will reset.

```
watchdog address: $1fca = 0001 1111 1100 1010

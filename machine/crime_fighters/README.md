...
![mad crime fighters video dac test](docs/images/mad_crime_fighters_video_dac_test.png)<br>
![mad crime fighters fix tile viewer](docs/images/mad_crime_fighters_fix_tile_viewer.png)
![mad crime fighters sprite viewer](docs/images/mad_crime_fighters_sprite_viewer.png)

## PCB Pictures
<a href="docs/images/crime_fighters_pcb_top.png"><img src="docs/images/crime_fighters_pcb_top.png" width="40%"></a>
<a href="docs/images/crime_fighters_pcb_bottom.png"><img src="docs/images/crime_fighters_pcb_bottom.png" width="40%"></a>
<p>

## Manual / Schematics
[Manual w/Schematics](docs/crime_fighters_manual_schematics.pdf)

## MAD Eproms

| Diag | Eprom Type | Location | Notes |
| ---- | ---------- | ----------- | ----- |
| Main | 27c010 | 821r02.f24 @ F24 | |
| Sound | 27c256 | H4 | No MAD ROM exists yet |

## RAM Locations
| RAM | Location | Type |
| -------- | :------- | ----- |
| Palette RAM (Odd Addresses) | F14 | MCM2018AN45 (2k x 8bit) |
| Palette RAM (Even Addresses) | F15 | MCM2018AN45 (2k x 8bit) |
| Sound RAM | H5 | MB8416A-15L-SK (2k x 8bit) |
| Sprite RAM | J3 | MCM2018AN45 (2k x 8bit) |
| Tile RAM | H23 | KM6264AL-10 (8k x 8bit) |
| Tile Attr RAM | I23 | KM6264AL-10 (8k x 8bit) |
| Work RAM | H21 | KM6264AL-10 (8k x 8bit) |
...
### Main CPU
The main CPU is a Konami2 CPU (rev: 052001).  If an error is encountered during
...
```
watchdog address: $3f88 = 0011 1111 1000 1000
...
<sup>Table last updated by gen-error-codes-markdown-table on 2025-05-18 @ 20:32 UTC</sup>
<!-- ec_table_main_end -->

...
palette_setup_color:
	...
	.loop_next_offset:
		...
		; all/combined has 2 colors to make a solid tile
		move.w	(a1)+, d1
		move.w	d0, (a0, d1.w)
		move.w	(a1)0, d1
		move.w	d0, (a0, d1.w)
...
PALETTE_OFFSETS:
	dc.w	TILE_B0_PAL_OFFSET, TILE_B1_PAL_OFFSET, TILE_B2_PAL_OFFSET, TILE_B3_PAL_OFFSET, TILE_BA_PAL_OFFSET1, TILE_BA_PAL_OFFSET2
...
TILES_ARRAY:
		dc.l TILE_B0_NUM | (1<<4), TILE_B1_NUM | (1<<4), TILE_B2_NUM | (1<<4), TILE_B3_NUM | (1<<4), TILE_BA_NUM | (1<<4)	; red
		dc.l TILE_B0_NUM | (2<<4), TILE_B1_NUM | (2<<4), TILE_B2_NUM | (2<<4), TILE_B3_NUM | (2<<4), TILE_BA_NUM | (2<<4)	; green
		dc.l TILE_B0_NUM | (3<<4), TILE_B1_NUM | (3<<4), TILE_B2_NUM | (3<<4), TILE_B3_NUM | (3<<4), TILE_BA_NUM | (3<<4)	; blue
		dc.l TILE_B0_NUM | (4<<4), TILE_B1_NUM | (4<<4), TILE_B2_NUM | (4<<4), TILE_B3_NUM | (4<<4), TILE_BA_NUM | (4<<4)	; all/combined

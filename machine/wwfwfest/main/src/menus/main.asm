...
d_menu_list:
	...
	MENU_ENTRY manual_fg_sprite_ram_tests, d_str_fg_sprite_ram_test
...
d_str_fg_sprite_ram_test:	STRING "FG/SPRITE RAM TEST"
...
d_str_video_dac_test:		STRING "VIDEO_DAC_TEST"
